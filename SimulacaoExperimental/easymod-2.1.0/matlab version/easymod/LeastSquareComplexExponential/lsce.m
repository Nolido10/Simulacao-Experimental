...
% fprintf('\n MaxMod = %f \n Tolerance in frequency = %f %% \n Tolerance in damping = %f %% \n', MaxMod, prec1*100, prec2*100)
...
%        InvCond(N) = 1/cond(A) ;
       ...
       %		- of least squares
%        epsilon(N) = norm(B-(A*x)); EDITEDDDD ------------- 03/11
...
% num=MaxMod ; %MODIFICADO
num=25;
warning off

% Results statement %% Nao tirar essa parte!
% [lsce_res,Y] = releve(FTEMP,XITEMP,TESTXI,num) ; %% nao modificar. Ele imprime o resultado que precisamos
[lsce_res] = releve(FTEMP,XITEMP,TESTXI,num) ; %% nao modificar. Ele imprime o resultado que precisamos
